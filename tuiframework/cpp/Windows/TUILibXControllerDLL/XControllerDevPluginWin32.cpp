...
#include <xcontroller\XControllerDev.h>
...
void dllInitPlugin() {
	DeviceFactorySingleton::getInstance()->registerCreateFunction(XControllerDev::getDeviceName(), XControllerDev::createFunction);
    deviceTypeNameVector.push_back(XControllerDev::getDeviceName());
}
...
void dllDeviceRegistration(IDeviceFactory * deviceFactory) {
    deviceFactory->registerCreateFunction(XControllerDev::getDeviceName(), XControllerDev::createFunction);
}
